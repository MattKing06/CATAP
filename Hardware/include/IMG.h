...
public:
	...
	*/
	...
	/*! Goes through all PV records stored in IMGRecords namespace, creates pvStructs and sets up their record/fullPVName before
		inserting them into a vector of pvStructs which is later used by the IMGFactory to setup connections to EPICS */
