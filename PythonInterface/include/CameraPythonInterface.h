...
namespace BOOST_PYTHON_CAMERA_INCLUDE
{
	...
	void expose_camera_object() 
	{
		...
		boost::python::class_<Camera, boost::python::bases<Hardware>, boost::noncopyable>("Camera", boost::python::no_init)
			...
			//.def("setXPix", &Camera::setXPix		)
			//.def("setYPix", &Camera::setYPix		)
			//.def("setSigXPix", &Camera::setSigXPix		)
			//.def("setSigYPix", &Camera::setSigYPix		)
			//.def("setSigXYPix", &Camera::setSigXYPix	)
	...
	void expose_camera_factory_object() 
	{
		...
		boost::python::class_<CameraFactory, boost::noncopyable>("CameraFactory", boost::python::no_init)
			...
			//.def("setXPix", &CameraFactory::setXPix)
			//.def("setYPix", &CameraFactory::setYPix)
			//.def("setSigXPix", &CameraFactory::setSigXPix)
			//.def("setSigYPix", &CameraFactory::setSigYPix)
			//.def("setSigXYPix", &CameraFactory::setSigXYPix)
