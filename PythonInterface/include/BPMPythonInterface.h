...
namespace BOOST_PYTHON_BPM_INCLUDE
{
	void expose_bpm_object() {
		...
		boost::python::class_<BPM, boost::python::bases<Hardware>, boost::noncopyable>("BPM", boost::python::no_init)
			...
			.add_property("data", &BPM::getData_Py)
			.add_property("q", &BPM::getQ)
			.add_property("xpvbuffer", &BPM::getXPVBuffer_Py)
			.add_property("ypvbuffer", &BPM::getYPVBuffer_Py)
			.add_property("databuffer", &BPM::getDataBuffer_Py)
			.add_property("qbuffer", &BPM::getQBuffer_Py)
			.add_property("xpvvector", &BPM::getXPVVector_Py)
			.add_property("ypvvector", &BPM::getYPVVector_Py)
			.add_property("datavector", &BPM::getDataVector_Py)
			.add_property("qvector", &BPM::getQVector_Py)
			.add_property("xbuffer", &BPM::getXPVBuffer_Py)
			.add_property("ybuffer", &BPM::getYPVBuffer_Py)
			.add_property("xvector", &BPM::getXPVVector_Py)
			.add_property("yvector", &BPM::getYPVVector_Py)
			.add_property("databuffer", &BPM::getDataBuffer_Py)
			.add_property("qbuffer", &BPM::getQBuffer_Py)
			...
			.def("detachContext", &BPM::detachFromInitialContext)
			.def("getXFromPV", &BPM::getXFromPV)
			.def("getYFromPV", &BPM::getYFromPV)
			.def("getData", &BPM::getData_Py)
			.def("getQ", &BPM::getQ)
			.def("getStatus", &BPM::getStatus)
			.def("getXPVBuffer", &BPM::getXPVBuffer_Py)
			.def("getYPVBuffer", &BPM::getYPVBuffer_Py)
			.def("getDataBuffer", &BPM::getDataBuffer_Py)
			.def("getQBuffer", &BPM::getQBuffer_Py)
			.def("getStatusBuffer", &BPM::getStatusBuffer_Py)
			.def("getXPVVector", &BPM::getXPVVector_Py)
			.def("getYPVVector", &BPM::getYPVVector_Py)
			.def("getDataVector", &BPM::getDataVector_Py)
			.def("getQVector", &BPM::getQVector_Py)
			.def("getStatusVector", &BPM::getStatusVector_Py)
	...
	void expose_bpm_factory_object() {
		...
		void(BPMFactory:: * detachContext_single)(const std::string&) = &BPMFactory::detachContext;
		void(BPMFactory:: * detachContext_all)(void) = &BPMFactory::detachContext;
		...
		boost::python::class_<BPMFactory>("BPMFactory", boost::python::no_init)
			...
			.def("detachContext", &BPMFactory::detachContext_Py)
