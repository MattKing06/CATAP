...
namespace BOOST_PYTHON_SCREEN_INCLUDE
{
	...
	void expose_screen_factory_object() {
		...
		boost::python::class_<ScreenFactory>("ScreenFactory", boost::python::no_init)
			...
			.def("isYAGNotIn", &ScreenFactory::isYAGNotIn)
			...
			.def("moveScreenIn", &ScreenFactory::moveScreenIn)
			.def("insertYAG", &ScreenFactory::insertYAG)
			.def("removeYAG", &ScreenFactory::removeYAG)
			.def("moveAllScreensOut", &ScreenFactory::moveAllScreensOut)
			.def("removeAllYAG", &ScreenFactory::removeAllYAG)
